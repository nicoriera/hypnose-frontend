  ...
  <div className="container">
    <div className="container-qui">
      <div className="qui">
        ...
        <p>
        Formé à l’hypnose Ericksonnienne et à la PNL (Programmation Neuro Linguistique) au sein de l’école de Psychothérapie Psynapse (Institut Européen reconnu par le World Hypnosis Organization (WHO)), je suis également diplômé de la spécialité gestion du poids et arrêt du tabac.
        </p>
        <p>
        Installé sur Hendaye au 14 boulevard Charles de Gaulle, je vous reçois sur rendez-vous les lundi, mardi, mercredi, jeudi et samedi matin. Parking gratuit à Gaztelu Zahar (140 mètres) Bus n°3 – Arrêt Ville (70 mètres) Bus n°33-35-37 – Arrêt Mairie (220 mètres)
        </p>
        </div>
